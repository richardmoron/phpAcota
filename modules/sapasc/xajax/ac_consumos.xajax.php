<?php 
	...
	*/
	...
	function loadfields($key){
		...
		$objResponse->assign("txt_fecha_lectura","value",$objac_consumosTO->getFecha_lectura());
		$objResponse->assign("txt_fecha_emision","value",$objac_consumosTO->getFecha_emision());
		...
		$objResponse->assign("txt_estado","value",$objac_consumosTO->getEstado());
		$objResponse->assign("txt_fecha_hora_pago","value",$objac_consumosTO->getFecha_hora_pago());
		$objResponse->assign("txt_usuario_pago","value",$objac_consumosTO->getUsuario_pago());
		$objResponse->assign("txt_monto_pagado","value",$objac_consumosTO->getMonto_pagado());
		$objResponse->assign("txt_pagado_por","value",$objac_consumosTO->getPagado_por());
		$objResponse->assign("txt_ci_pagado_por","value",$objac_consumosTO->getCi_pagado_por());
	...
	function loadtable_default($page_number,$arraylist,$table_count,$criterio){
		...
		$strhtml .= '<thead>'."\n";
		$strhtml .= '<tr>'."\n";
		$strhtml .= '<th scope="col">Consumo_id<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Socio_id<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Nro_medidor<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Fecha_lectura<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Fecha_emision<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Periodo_mes<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Periodo_anio<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Consumo_total_lectura<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Consumo_por_pagar<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Costo_consumo_por_pagar<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Estado<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Fecha_hora_pago<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Usuario_pago<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Monto_pagado<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Pagado_por<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		$strhtml .= '<th scope="col">Ci_pagado_por<img src="'.MY_URI.'/media/img/tablesorter/bg.gif" alt="ordenar" class="order-img"/></th>'."\n";
		...
		//-- IBRAC
			while($iterator->valid()) {
				...
				$strhtml .= '<td>'.$objac_consumosTO->getConsumo_id().'</td>'."\n";
				$strhtml .= '<td>'.$objac_consumosTO->getSocio_id().'</td>'."\n";
				$strhtml .= '<td>'.$objac_consumosTO->getNro_medidor().'</td>'."\n";
				$strhtml .= '<td>'.$objac_consumosTO->getFecha_lectura().'</td>'."\n";
				$strhtml .= '<td>'.$objac_consumosTO->getFecha_emision().'</td>'."\n";
				...
				$strhtml .= '<td>'.$objac_consumosTO->getEstado().'</td>'."\n";
				$strhtml .= '<td>'.$objac_consumosTO->getFecha_hora_pago().'</td>'."\n";
				$strhtml .= '<td>'.$objac_consumosTO->getUsuario_pago().'</td>'."\n";
				$strhtml .= '<td>'.$objac_consumosTO->getMonto_pagado().'</td>'."\n";
				$strhtml .= '<td>'.$objac_consumosTO->getPagado_por().'</td>'."\n";
				$strhtml .= '<td>'.$objac_consumosTO->getCi_pagado_por().'</td>'."\n";
				//-- IBRAC
	...
	function save($aFormValues){
		...
		try{
			if($valid){
				...
				$objac_consumosTO->setNro_medidor($aFormValues['txt_nro_medidor']);
				$objac_consumosTO->setFecha_lectura($aFormValues['txt_fecha_lectura']);
				$objac_consumosTO->setFecha_emision($aFormValues['txt_fecha_emision']);
				...
				$objac_consumosTO->setConsumo_por_pagar($aFormValues['txt_consumo_por_pagar']);
				$objac_consumosTO->setCosto_consumo_por_pagar($aFormValues['txt_costo_consumo_por_pagar']);
				$objac_consumosTO->setEstado($aFormValues['txt_estado']);
				$objac_consumosTO->setFecha_hora_pago($aFormValues['txt_fecha_hora_pago']);
				$objac_consumosTO->setUsuario_pago($aFormValues['txt_usuario_pago']);
				...
				if($aFormValues['txt_consumo_id'] == '0' )
					$objac_consumosDAO->insertac_consumos($objac_consumosTO);
				else
	...
	function add(){
		...
		$objResponse->assign("txt_fecha_lectura","value","");
		$objResponse->assign("txt_fecha_emision","value","");
		$objResponse->assign("txt_periodo_mes","value","");
		$objResponse->assign("txt_periodo_anio","value","");
		$objResponse->assign("txt_consumo_total_lectura","value","");
		$objResponse->assign("txt_consumo_por_pagar","value","");
		$objResponse->assign("txt_costo_consumo_por_pagar","value","");
		$objResponse->assign("txt_estado","value","");
		$objResponse->assign("txt_fecha_hora_pago","value","");
		$objResponse->assign("txt_usuario_pago","value","");
		$objResponse->assign("txt_monto_pagado","value","");
	...
	function valid($aFormValues,$objResponse){
		...
		$objResponse = clearvalid($objResponse);
			...
			if(trim($aFormValues['txt_fecha_emision']) == ""){
				$objResponse->assign("valid_fecha_emision","innerHTML", '<img src="../../../../media/img/actions/alert.png" alt="Requerido" title="Requerido" />');
				$valid = false;
			}
			...
			if(trim($aFormValues['txt_consumo_total_lectura']) == ""){
				$objResponse->assign("valid_consumo_total_lectura","innerHTML", '<img src="../../../../media/img/actions/alert.png" alt="Requerido" title="Requerido" />');
				$valid = false;
			}
			if(trim($aFormValues['txt_consumo_por_pagar']) == ""){
				$objResponse->assign("valid_consumo_por_pagar","innerHTML", '<img src="../../../../media/img/actions/alert.png" alt="Requerido" title="Requerido" />');
				$valid = false;
			}
			if(trim($aFormValues['txt_costo_consumo_por_pagar']) == ""){
				$objResponse->assign("valid_costo_consumo_por_pagar","innerHTML", '<img src="../../../../media/img/actions/alert.png" alt="Requerido" title="Requerido" />');
				$valid = false;
			}
			...
			if(trim($aFormValues['txt_fecha_hora_pago']) == ""){
				$objResponse->assign("valid_fecha_hora_pago","innerHTML", '<img src="../../../../media/img/actions/alert.png" alt="Requerido" title="Requerido" />');
				$valid = false;
			}
			if(trim($aFormValues['txt_usuario_pago']) == ""){
				$objResponse->assign("valid_usuario_pago","innerHTML", '<img src="../../../../media/img/actions/alert.png" alt="Requerido" title="Requerido" />');
				$valid = false;
			}
			if(trim($aFormValues['txt_monto_pagado']) == ""){
	...
	function readOnlyfiles($state, $objResponse = null, $title = null){
		...
		$objResponse->script("readonly('formulario','txt_fecha_emision',$state)");
		...
		$objResponse->script("readonly('formulario','txt_fecha_hora_pago',$state)");
		$objResponse->script("readonly('formulario','txt_usuario_pago',$state)");
		$objResponse->script("readonly('formulario','txt_monto_pagado',$state)");
		$objResponse->script("readonly('formulario','txt_pagado_por',$state)");
		$objResponse->script("readonly('formulario','txt_ci_pagado_por',$state)");
		if($state == "false"){
			$objResponse = visibilityButton("savebutton", "visible", $objResponse);
			$objResponse = visibilityButton("editbutton", "hidden", $objResponse);
		}else{

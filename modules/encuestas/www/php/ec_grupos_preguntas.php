<?php require_once dirname(dirname(dirname(__FILE__)))."/xajax/ec_grupos_preguntas.xajax.php"; ?>
...
<html>
    <head>
		...
		<title>ec_grupos_preguntas</title>
						...
						<div class="inputs_tr" >
							<div class="inputs_td" >
								<span class="labels" >Nombre</span>
                                                                <input type="text" value="" name="txts_nombre" id="txts_nombre" onkeyup="enter(event);" style="width: 250px;"/>
							</div>
							<div class="inputs_td" >
                                                            <span class="labels" >Tipo</span>
                                                            <span id="ctns_cbx_tipo"></span>
                                                        </div>
						</div>
					</div>
				</div>
			...
			<div id="fields" name="fields" class="title_panel">
				...
				<div class="panel_inputs">
					...
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">Encuesta</span>
                                                        ...
                                                        <input id="btn_link1" name="btn_link1" type="button" value="Buscar" onclick="callLovGeneric('txt_encuesta_id','txt_nombre_encuesta','<?php echo MY_SUBURL;?>/modules/encuestas/www/php/ec_encuestas_lov.php',false)" style="width: 60px;height: 21px;" />
					...
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">Tipo</span>
							<span id="ctn_cbx_tipo"></span>
							<span id="valid_tipo" name="valid_tipo" class="validfield"></span>
						</div>
					</div>
				</div>
			</div>

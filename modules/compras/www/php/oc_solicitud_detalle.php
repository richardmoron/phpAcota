<?php require_once dirname(dirname(dirname(__FILE__)))."/xajax/oc_solicitud_detalle.xajax.php"; ?>
...
<html>
	<head>
		...
		<title>oc_solicitud_detalle</title>
		...
		<form action="#" method="post" id="formulario">
			...
			<div id="fields" name="fields" class="title_panel">
				...
				<div class="panel_inputs">
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">oc_solicitud_detalle_id</span>
							<input id="txt_oc_solicitud_detalle_id" name="txt_oc_solicitud_detalle_id" type="text" readonly="readonly" maxlength="" style="width: 250px;"/>
							<span id="valid_oc_solicitud_detalle_id" name="valid_oc_solicitud_detalle_id"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
					...
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">no_linea</span>
							<input id="txt_no_linea" name="txt_no_linea" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_no_linea" name="valid_no_linea"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">tipo_solicitud</span>
							<input id="txt_tipo_solicitud" name="txt_tipo_solicitud" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_tipo_solicitud" name="valid_tipo_solicitud"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">cod_tipo</span>
							<input id="txt_cod_tipo" name="txt_cod_tipo" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_cod_tipo" name="valid_cod_tipo"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">cod_grupo</span>
							<input id="txt_cod_grupo" name="txt_cod_grupo" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_cod_grupo" name="valid_cod_grupo"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">cod_subgrupo</span>
							<input id="txt_cod_subgrupo" name="txt_cod_subgrupo" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_cod_subgrupo" name="valid_cod_subgrupo"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">codigo_referencia</span>
							<input id="txt_codigo_referencia" name="txt_codigo_referencia" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_codigo_referencia" name="valid_codigo_referencia"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">nombre_referencia</span>
							<input id="txt_nombre_referencia" name="txt_nombre_referencia" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_nombre_referencia" name="valid_nombre_referencia"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">unidad_medida</span>
							<input id="txt_unidad_medida" name="txt_unidad_medida" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_unidad_medida" name="valid_unidad_medida"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">cantidad</span>
							<input id="txt_cantidad" name="txt_cantidad" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_cantidad" name="valid_cantidad"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">cantidad_aprobada</span>
							<input id="txt_cantidad_aprobada" name="txt_cantidad_aprobada" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_cantidad_aprobada" name="valid_cantidad_aprobada"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">cantidad_pendiente</span>
							<input id="txt_cantidad_pendiente" name="txt_cantidad_pendiente" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_cantidad_pendiente" name="valid_cantidad_pendiente"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >
					...
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">no_docto_referencia</span>
							<input id="txt_no_docto_referencia" name="txt_no_docto_referencia" type="text" maxlength=" style="width: 250px;""/>
							<span id="valid_no_docto_referencia" name="valid_no_docto_referencia"></span>
						</div>
					</div>
					<div class="inputs_tr" >
						<div class="inputs_td" >

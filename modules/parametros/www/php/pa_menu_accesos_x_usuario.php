<?php require_once dirname(dirname(dirname(__FILE__)))."/xajax/pa_menu_accesos_x_usuario.xajax.php"; ?>
...
<html>
    <head>
		...
		<title>Accesos al Men&uacute; por Usuarios</title>
	...
	<body onload="xajax_preload();">
		...
		<form action="#" method="post" id="formulario">
					...
					<div class="panel_inputs">
						<div class="inputs_tr" >
							...
							<div class="inputs_td" >
                                                            ...
                                                            <input id="txts_menu_id" name="txts_menu_id" type="hidden" maxlength="11"style="" />
			...
			<div id="fields" name="fields" class="title_panel">
				...
				<div class="panel_inputs">
                                    <input id="txt_menu_acceso_x_usuario_id" name="txt_menu_acceso_x_usuario_id" type="hidden" readonly="readonly" maxlength="11" style="width: 250px;"/>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">Usuario</span>
                                                        <input id="txt_usuario_id" name="txt_usuario_id" type="hidden" maxlength="25" style="width: 250px;"/>
                                                        <input id="txt_usuario_nombres" name="txt_usuario_nombres" type="text" maxlength="25" style="width: 250px;"/>
                                                        <input id="btn_link1" name="btn_link1" type="button" value="Buscar" onclick="callLovUsuarios('txt_usuario_id','txt_usuario_nombres')" style="width: 60px;height: 21px;" />
					...
					<div class="inputs_tr" >
						<div class="inputs_td" >
                                                        ...
                                                        <input id="txt_menu" name="txt_menu" type="text" maxlength="11" style="width: 250px;" />
                                                        <input id="btn_link2" name="btn_link2" type="button" value="Buscar" onclick="callLov('txt_menu_id','txt_menu')" style="width: 60px;height: 21px;" />

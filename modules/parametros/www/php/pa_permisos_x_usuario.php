<?php require_once dirname(dirname(dirname(__FILE__)))."/xajax/pa_permisos_x_usuario.xajax.php"; ?>
	...
	<body onload="xajax_preload();">
		...
		<form action="#" method="post" id="formulario">
			...
			<div id="fields" name="fields" class="title_panel">
				...
				<div class="panel_inputs">
                                        <input id="txt_permisos_x_usuario_id" name="txt_permisos_x_usuario_id" type="hidden" readonly="readonly" maxlength="11" style="width: 250px;"/>
					<div class="inputs_tr" >
						<div class="inputs_td" >
							<span class="labels">Usuario</span>
					...
					<div class="inputs_tr" >
						<div class="inputs_td" >
							...
							<input id="txt_archivo" name="txt_archivo" type="text" maxlength="50" style="width: 250px;"/>
                                                        <input id="btn_link2" name="btn_link2" type="button" value="Buscar" onclick="callFileBrowser('txt_archivo',false)" style="width: 60px;height: 21px;" />
